    ...
    ReentrancyGuardUpgradeable
{
    ...
    mapping(uint256 => uint256) public validatorCounter;
    ...
    function createNewBatch(
        ...
        require(
            tokenIdCounter + tier1Batch + tier2Batch <=
                validatorMaxSupply,
            "exceed Max Total Supply"
        );
        mintBatch[1] = tier1Batch;
        mintBatch[2] = tier2Batch;
        validatorCounter[1] = 0;
        validatorCounter[2] = 0;
    ...
    function _mintValidator(address to, uint256 tier) internal {
        require(
            validatorCounter[tier] < mintBatch[tier],
            "Exceed batch amount"
        );
        uint256 tokenId = tokenIdCounter;

        validatorMintLevel[tokenId] = tier;
        validatorCounter[tier] += 1;
        tokenIdCounter += 1;
    ...
    function setReferral(
        ...
        require(validatorTokenId < tokenIdCounter, "Not A Valid Referral");
